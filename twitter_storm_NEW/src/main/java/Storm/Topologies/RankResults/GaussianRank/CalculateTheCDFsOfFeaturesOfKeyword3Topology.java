 ...
 */
public class CalculateTheCDFsOfFeaturesOfKeyword3Topology {
    public static final String PATH_TO_EXPERTS_OF_KEYWORD_TEXT_FILE="/home/christina/twitter_storm_NEW/ExpertsOfKeywords/ExpertsOfKeyword3.txt";
    public static final String PATH_TO_CDFS_OF_AUTHORS="/home/christina/twitter_storm_NEW/CDFs_Of_Features/experts_and_cdfs_of_features_of_keyword3.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args != null && args.length > 0) {
            ...
            StormSubmitter.submitTopology("Calculating_The_CDFs_Of_The_Experts_Of_Keyword3", config, topologyBuilder.createTopology());
        } else {
            LocalCluster localCluster = new LocalCluster();
            localCluster.submitTopology("Calculating_The_CDFs_Of_The_Experts_Of_Keyword3", config, topologyBuilder.createTopology());
            Utils.sleep(20 * 1000);
            localCluster.killTopology("Calculating_The_CDFs_Of_The_Experts_Of_Keyword3");
