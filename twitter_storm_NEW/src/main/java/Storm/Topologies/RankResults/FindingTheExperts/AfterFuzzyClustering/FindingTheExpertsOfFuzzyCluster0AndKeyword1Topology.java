 ...
 */
public class FindingTheExpertsOfFuzzyCluster0AndKeyword1Topology {
    ...
    public static final String PATH_TO_EXPERTS_OF_FUZZY_CLUSTER="/home/christina/twitter_storm_NEW/ExpertsOfKeywords/ExpertsOfKeyword1AndFuzzyCluster0.txt";

    public static void main(String[] args) throws AlreadyAliveException, Exception {
        TopologyBuilder topologyBuilder = new TopologyBuilder();
        topologyBuilder.setSpout("PROCESS_GAUSSIAN_PROBABILITIES_FROM_TEXT_FILE",new FindingTheExpertsOfFuzzyClusterSpout1(PATH_TO_GAUSSIAN_PROBABILITIES_TEXT_FILE,0,1));
