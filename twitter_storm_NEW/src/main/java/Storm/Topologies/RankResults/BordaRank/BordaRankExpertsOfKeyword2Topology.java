 ...
 */
public class BordaRankExpertsOfKeyword2Topology {
    public static final String PATH_TO_EXPERTS_OF_KEYWORD_TEXT_FILE="/home/christina/twitter_storm_NEW/ExpertsOfKeywords/ExpertsOfKeyword2AfterFuzzyClustering.txt";
    public static final String RANKED_EXPERTS_OF_KEYWORD="/home/christina/twitter_storm_NEW/Borda_Ranked_Experts/Ranked_Experts_Of_Keyword2.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args != null && args.length > 0) {
            ...
            StormSubmitter.submitTopology("Borda_Rank_The_Experts_Of_Keyword2", config, topologyBuilder.createTopology());
        } else {
            LocalCluster localCluster = new LocalCluster();
            localCluster.submitTopology("Borda_Rank_The_Experts_Of_Keyword2", config, topologyBuilder.createTopology());
            Utils.sleep(20 * 1000);
            localCluster.killTopology("Borda_Rank_The_Experts_Of_Keyword2");
