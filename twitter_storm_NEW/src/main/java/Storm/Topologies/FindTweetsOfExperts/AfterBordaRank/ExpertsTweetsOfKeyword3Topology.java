 ...
 */
public class ExpertsTweetsOfKeyword3Topology {
    public static final String PATH_TO_RANKED_EXPERTS_FILE="/home/christina/twitter_storm_NEW/Borda_Ranked_Experts/Ranked_Experts_Of_Keyword3.txt";
    public static final String PATH_TO_TWEETS_FILE="/home/christina/twitter_storm_NEW/Tweets_Seperated_Based_On_Keywords/authors_and_tweets_of_keyword3.txt";

    public static final String PATH_TO_RANKED_EXPERTS_AND_TWEETS_FILE="/home/christina/twitter_storm_NEW/Tweets_Of_Borda_Ranked_Experts/tweets_of_keywords3_borda_ranked_experts.txt";
    ...
    public static void main(String[] args) throws Exception{
        ...
        if(args!=null && args.length>0){
            ...
            localCluster.submitTopology("Finding_The_Experts_Of_Keyword3_Tweets",config,topologyBuilder.createTopology());
            Utils.sleep(2*100*1000);
            localCluster.killTopology("Finding_The_Experts_Of_Keyword3_Tweets");
